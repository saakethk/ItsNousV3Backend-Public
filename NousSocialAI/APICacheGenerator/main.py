...
class Firebase():
    ...
    def __init__(self):
        self.creds = credentials.Certificate("Place Firebase Creds Here")
...
class Finnhub():
    ...
    def __init__(self):
        ...
        self.key = "[Redacted]"
        self.finnhub_client = finnhub.Client(api_key=self.key)
...
class HumorAPI():
    ...
    def __init__(self):
        self.display_name = "HumorAPI"
        self.description = "HumorAPI stores thousands of jokes that are sure to make you laugh and returns them in a easy-to-read JSON format."
        self.key = "[Redacted]"
